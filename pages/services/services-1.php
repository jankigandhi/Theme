...
<main>
	...
	<div class="services-section">
		<div class="container">
			<div class="icon-with-box">
				<div class="my-5">
					<p class="text-primary text-center text-uppercase font-weight-bold mb-0">What We Do</p>
					<h3 class="mw-600 mx-auto text-center font-weight-medium py-3 mb-0">We’ve got everything you need to launch and grow your business</h3>
				</div>
				<div class="row mx-0">
					<div class="col-md-6 py-4">
						<div class="row mx-0">
							<div class="col-md-2 text-center">
								<span class="services-icon text-primary">
