...
<link rel="stylesheet" type="text/css" href="../../components/accordions/css/accordions.css">
<link rel="stylesheet" type="text/css" href="../../components/progressbar/css/progressbar.css">
<link rel="stylesheet" type="text/css" href="../../components/card/css/card.css">
...
<main>
    ...
    <div class="features-section text-center py-5">
        <div class="container">
            <h3 class="text-uppercase">Capital Unlimited Features</h3>
            <p class="light-gray">Absolutely Stunning Design and Functionality</p>
            <div class="row">
                <div class="col-md-4 py-3">
                    <div class="features-box shadow-sm px-3 py-4">
                        <div class="circle-icon rounded-circle d-flex justify-content-center align-items-center mx-auto mb-3">
                            <span class="icon"><i class="fas fa-power-off"></i></span>
                        </div>
                        <h5>Development</h5>
                        <p class="light-gray small px-4 mb-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry.printing and typesetting industry.</p>
                    </div>
                </div>
                <div class="col-md-4 py-3">
                    <div class="features-box shadow-sm px-3 py-4">
    ...
    <div class="pricing-table py-5 text-center">
        <div class="container">
            ...
            <div class="row mx 0 my-5">
                <div class="col-lg-3 col-sm-6 py-4">
                    <div class="card">
                        <div class="card-body pricing-section">
                            <h4 class="product-title">Standard</h4>
                            <div class="circle-table rounded-circle mx-auto my-4">
                            ...
                            <ul class="list-unstyled">
                                <li class="product-list my-2">15 Projects</li>
                                <li class="product-list my-2">2 Email Marketing</li>
                                <li class="product-list my-2">5 Data Base</li>
                                <li class="product-list my-2">30 GB Stroge</li>
                                <li class="product-list my-2">Unlimited Data Transfer</li>
                                <li class="product-list my-2">50 GB Bandwith</li>
                                <li class="product-list my-2">Enhanced Security</li>
                            </ul>
                            <div class="my-4">
                                <button class="rounded-0 btn btn-primary p">Get Started Now</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 py-4">
                    <div class="card">
                        <div class="card-body pricing-section">
                            ...
                            <div class="my-4">
                                <button class="rounded-0 btn btn-primary font-weight-medium">Get Started Now</button>
                            </div>
                ...
                <div class="col-lg-3 col-sm-6 py-4">
                    <div class="card">
                        <div class="card-body pricing-section">
                            <h4 class="product-title">Premium</h4>
                            <div class="circle-table rounded-circle mx-auto my-4">
                                <div class="circle-text">
                                    <p class="mb-0 small d-flex align-items-start">$
                ...
                <div class="col-lg-3 col-sm-6 py-4">
                    <div class="card">
                        <div class="card-body pricing-section">
                            <h4 class="product-title">Ultimate</h4>
                            <div class="circle-table rounded-circle mx-auto my-4">
                                <div class="circle-text">
                                    <p class="mb-0 small d-flex align-items-start">$
    ...
    <div class="accordion-section py-5 text-center">
        <div class="container">
            <h3 class="text-uppercase">Capital Best Services</h3>
            <p class="light-gray">Absolutely Stunning Design and Functionality</p>
            <ul class="list-unstyled accordion alternate-color multiple-open text-left mb-0 my-4">
