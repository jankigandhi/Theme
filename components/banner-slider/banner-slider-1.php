...
var onhover = document.querySelector('.banner-section .swiper-container').swiper
        $(".banner-section .swiper-container").mouseenter(function() {
        onhover.autoplay.stop();
        });
        $(".banner-section .swiper-container").mouseleave(function() {
