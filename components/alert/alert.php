...
<div class="container">
	...
	<div class="py-3">
		<h3>Style-2</h3>
		<div class="alert-left-border alert alert-dark rounded-0">
			<i class="zmdi zmdi-thumb-up"></i>
			<strong class="pl-2">Well done!</strong> You successfully read this important alert message.
			<button type="button" class="close">×</button>
		</div>
		<div class="alert-left-border alert alert-secondary rounded-0">
			<i class="zmdi zmdi-thumb-up"></i>
			<strong class="pl-2">Well done!</strong> You successfully read this important alert message.
			<button type="button" class="close">×</button>
		</div>
		<div class="alert-left-border alert alert-success rounded-0">
			<i class="zmdi zmdi-thumb-up"></i>
			<strong class="pl-2">Well done!</strong> You successfully read this important alert message.
			<button type="button" class="close">×</button>
		</div>
		<div class="alert-left-border alert alert-danger rounded-0">
			<i class="zmdi zmdi-thumb-up"></i>
			<strong class="pl-2">Well done!</strong> You successfully read this important alert message.
			<button type="button" class="close">×</button>
		</div>
		<div class="alert-left-border alert alert-warning rounded-0">
			<i class="zmdi zmdi-thumb-up"></i>
			<strong class="pl-2">Well done!</strong> You successfully read this important alert message.
			<button type="button" class="close">×</button>
		</div>
		<div class="alert-left-border alert alert-info rounded-0">
			<i class="zmdi zmdi-thumb-up"></i>
			<strong class="pl-2">Well done!</strong> You successfully read this important alert message.
			<button type="button" class="close">×</button>
		</div>
		<div class="alert-left-border alert alert-light rounded-0">
			<i class="zmdi zmdi-thumb-up"></i>
			<strong class="pl-2">Well done!</strong> You successfully read this important alert message.
			<button type="button" class="close">×</button>
		</div>
	...
	<div class="py-3">
		...
		<div class="alert-left-border alert alert-success rounded-0 p-0">
			<h6 class="alert-title p-3 font-weight-bold mb-0">Well done!</h6>
			<div class="p-3">
				<ul class="mb-0">
		...
		<div class="alert-left-border alert alert-success rounded-0 p-0">
			<h6 class="alert-title p-3 font-weight-bold mb-0"><i class="pr-3 zmdi zmdi-edit"></i>Fix the Following Errors:</h6>
			<div class="p-3">
				<ul class="mb-0">
					<li>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sequi, adipisci.</li>
					<li>Placeat, et hic pariatur fugiat autem earum facere necessitatibus fuga.</li>
