...
<div class="my-4 text-center">
    ...
    <div class="button-group filters-button-group d-inline-block">
        <button class="custom-btn btn btn-link active" data-filter="*">show all</button>
        ...
        <button class="custom-btn btn btn-link" data-filter="numberLessThan50">Web Designer</button>
        <button class="custom-btn btn btn-link" data-filter="numberGreaterThan50">number > 50</button>
        <button class="custom-btn btn btn-link" data-filter="ium">name ends with &ndash;ium</button>
    </div>
</div>
<div class="container">
    <div class="grid-overflow">
        <div class="grid row mx-0">
            <div class="col-lg-3 col-sm-6 element-item transition pb-4" data-category="transition">
                <div class="custom-card card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text small mb-3">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        <a href="#" class="btn-effect effect-5 btn-thick rounded-0 btn btn-outline-dark py-2 px-3"><span>Go somewhere</span></a>
                ...
                <div class="custom-card card">
                    ...
                    <div class="card-footer bg-dark text-white text-center">
                        <ul class="list-unstyled mb-0 d-flex justify-content-between">
                            <li class="d-inline-block p-1">
                                <span class="d-inline-block"><i class="zmdi zmdi-time"></i></span>
                                <p class="num d-inline-block mb-0">60</p>
                            </li>
                            <li class="d-inline-block p-1">
                                <span class="d-inline-block"><i class="zmdi zmdi-comments"></i></span>
                                <p class="number d-inline-block mb-0">12</p>
                            ...
                            <li class="d-inline-block p-1">
                                <span class="d-inline-block"><i class="zmdi zmdi-twitter"></i></span>
                                <p class="number d-inline-block mb-0">35</p>
                ...
                <div class="custom-card card">
                    ...
                    <div class="card-footer bg-dark text-white text-center">
                        <ul class="list-unstyled mb-0 d-flex justify-content-between">
                            <li class="d-inline-block p-1">
                                <span class="d-inline-block"><i class="zmdi zmdi-time"></i></span>
                                <p class="num d-inline-block mb-0">1</p>
                            </li>
                            <li class="d-inline-block p-1">
                                <span class="d-inline-block"><i class="zmdi zmdi-comments"></i></span>
                                <p class="number d-inline-block mb-0">72</p>
                            </li>
                            <li class="d-inline-block p-1">
                                <span class="d-inline-block"><i class="zmdi zmdi-facebook"></i></span>
                                <p class="number d-inline-block mb-0">21</p>
                            ...
                            <li class="d-inline-block p-1">
                                <span class="d-inline-block"><i class="zmdi zmdi-twitter"></i></span>
                                <p class="number d-inline-block mb-0">85</p>
                ...
                <div class="custom-card card">
                    ...
                    <div class="card-footer bg-dark text-white text-center">
                        <ul class="list-unstyled mb-0 d-flex justify-content-between">
                            <li class="d-inline-block p-1">
                                <span class="d-inline-block"><i class="zmdi zmdi-time"></i></span>
                                <p class="num d-inline-block mb-0">6</p>
                            </li>
                            <li class="d-inline-block p-1">
                                <span class="d-inline-block"><i class="zmdi zmdi-comments"></i></span>
                                <p class="number d-inline-block mb-0">22</p>
                            </li>
                            <li class="d-inline-block p-1">
                                <span class="d-inline-block"><i class="zmdi zmdi-facebook"></i></span>
                                <p class="number d-inline-block mb-0">21</p>
                ...
                <div class="custom-card card">
                    ...
                    <div class="card-footer bg-dark text-white text-center">
                        <ul class="list-unstyled mb-0 d-flex justify-content-between">
                            <li class="d-inline-block p-1">
                                <span class="d-inline-block"><i class="zmdi zmdi-time"></i></span>
                                <p class="num d-inline-block mb-0">81</p>
                            </li>
                            <li class="d-inline-block p-1">
                                <span class="d-inline-block"><i class="zmdi zmdi-comments"></i></span>
                                <p class="number d-inline-block mb-0">12</p>
                            ...
                            <li class="d-inline-block p-1">
                                <span class="d-inline-block"><i class="zmdi zmdi-facebook"></i></span>
                                <p class="number d-inline-block mb-0">11</p>
                            </li>
                            <li class="d-inline-block p-1">
                                <span class="d-inline-block"><i class="zmdi zmdi-twitter"></i></span>
                                <p class="number d-inline-block mb-0">25</p>
                            </li>
                        </ul>
                    </div>
                </div>
