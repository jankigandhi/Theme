            ...
            <div class="header-container container">
                <div class="logo-class float-left">
                    <a href="../../pages/theme-home/home.php" class="d-inline-block">
                        <img class="logo-icon-b mw-100" src="../../images/logo-b.png" alt="Theme-logo-blue"/>
                        <img class="logo-icon-w  mw-100" src="../../images/logo-w.png" alt="Theme-logo-white"/>
                    </a>
                </div>
                            ...
                            <ul class="sub-menu list-unstyled">
                                <li class="menu-col">
                                    <ul class="list-unstyled">
                                        ...
                                        <li class="sub-menu-link">
                                            <a href="../../pages/about/about-1.php" class="hover-links text-uppercase">About2</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="menu-col">
                                    <ul class="list-unstyled">
                                        ...
                                        <li class="sub-menu-link">
                                            <a href="../../pages/service/service-1.php" class="hover-links text-uppercase">Service2</a>
                                        </li>
                                        <li class="sub-menu-link">
                            ...
                            <ul class="sub-menu list-unstyled">
                                ...
                                <li class="menu-col">
                                    <ul class="list-unstyled">
                                        ...
                                        <li class="sub-menu-link">
                                            <a href="../../components/call-to-actions/call-actions.php" class="hover-links text-uppercase">Call To Actions</a>
                                        </li>
                                        <li class="sub-menu-link">
                                ...
                                <li class="menu-col">
                                    <ul class="list-unstyled">
                                        ...
                                        <li class="sub-menu-link">
                                            <a href="../../components/nav-bar/default-navbar.php" class="hover-links text-uppercase">Default navbar</a>
                                        </li>
                                        <li class="sub-menu-link">
                                            <a href="../../components/nav-bar/transparent-navbar.php" class="hover-links text-uppercase">Transparent navbar</a>
                                        </li>
                                        <li class="sub-menu-link">
                                            <a href="../../components/nav-bar/fixed-navbar.php" class="hover-links text-uppercase">Fixed navbar</a>
                                        </li>
                                        <li class="sub-menu-link">
