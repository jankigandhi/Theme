...
<body>
    <div class="container">
        <div class="max-width mx-auto">
            ...
            <div class="row call-to-action my-5 mx-0 align-items-center justify-content-md-between justify-content-center">
            ...
            <div class="row call-to-action with-border rounded my-5 mx-0 align-items-center p-3 justify-content-md-between justify-content-center">
                <div>
