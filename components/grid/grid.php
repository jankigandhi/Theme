...
<div class="container">
    <div class="text-center my-4">
        <h1 class="h2 text-center mt-3">Grid Structure</h1>
        <h4 class="text-uppercase">Bootstrap Rows & Columns</h4>
        <p>
            Foundry utilises the powerful Bootstrap 12 column grid structure. Template elements placed inside columns and rows will span the entirety of their container by default.
        </p>
    </div>
    <div>
